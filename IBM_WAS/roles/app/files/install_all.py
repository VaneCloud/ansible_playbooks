# Copyright 2013 International Business Machines
#牋 Licensed under the Apache License, Version 2.0 (the "License");
#牋 you may not use this file except in compliance with the License.
#牋 You may obtain a copy of the License at
#牋牋牋爃ttp://www.apache.org/licenses/LICENSE-2.0
#牋 Unless required by applicable law or agreed to in writing, software
#牋 distributed under the License is distributed on an "AS IS" BASIS,
#牋 WITHOUT WARRANTIES OR CONDITIONS OF ANY KIND, either express or implied.
#牋 See the License for the specific language governing permissions and
#牋 limitations under the License.
...
DefaultTradeAppName = "DayTrader3-EE6"
DefaultEarFile =      "daytrader3-ee6.ear"
